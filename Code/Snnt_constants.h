...
static float Threshold[2] = {7., 7.}; // Neuron threshold in arbitrary units; in paper it is 550V but they have 1000 channels, 100x ours
...
static float a_plus = 0.0003125;          // for model of EPSP
static float a_minus = 0.0002656;       // 0.85*a_plus;
