...
void SNN_Tracking(SNN &snn_in, int file_id_GS = -1)
{
    ...
    */
    ...
    // // Loop on events for adjust threshold ----------------------------------------------
    // // TODO: Fix it 
    // bool t_insert = true;
    ...
    // for (int t_event = 0; t_event < t_EV; t_event++)
    // {
    //     t_iev_thisepoch++;
    ...
    //         cout << " THRESHOLD ADJUSTING ->     Ev. # " << t_event + 1 << " - LR = " << LR << "; Selectivity L0 = " << selectivityL0 << " L1 = " << selectivityL1
    ...
    //         if (mean_firing_rate > t_EV / 10)
    //         {
    //             cout << "Firing rate is less than 1/10 of the total number of events" << endl;
    //         }

    //         cout << endl;

    //         cout << "TRESH Fabio -----------------------" << endl;
