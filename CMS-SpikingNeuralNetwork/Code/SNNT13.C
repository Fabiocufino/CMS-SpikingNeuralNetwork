     ...
     //for (NevPerEpoch=1)   
        ...
        for (int ispike = 0; ispike < PreSpike_Time.size(); ispike++)
        {
            ...
            else
            {
                ...
                {
                  //REE AND REB DONE///
                      //finding target event to determine the number of events to reach 80% of the current interval
     ...
     //   if ((ievent+1)%10000==0 && ievent!=0)
       if (ievspecial%10000==0) 
        { //// we did NevPerEpoch events
         ...
         cout<<"Count "<<count_step<<endl;//prints the intervals(steps)
...
//arreys to store the values of evaluation metrics
     ...
     monitor_fakerateL1[count_step-1]=Acc_best_L1;
            ...
            { // The first time we modify at random the parameters
                ...
                { //cout<<"HEYH "<<endl;
                    ...
                    //cout<<"checking  "<<snn_in.Threshold[0]<<endl;
...
// cout<<"Count "<<count_step<<endl;
  count_step++;
//cout<<"HEYll "<<snn_best.Threshold[0]<<endl;
//cout<<"HEYlololo old "<< snn_in.Threshold[0]<<endl;
